...
//   <label className="form-check-label"  style={{ color: "black" }} for="switchCheckDefault">Enable Dark Mode</label>
// </div>
//     </div>
//   </div>
// </nav>
...
// made enhancemnet my utility app with react js and bootstrap 5.3.2
...
export default function Navbar(props) {
  return (
    <nav
      ...
      style={{
        backgroundColor: props.mode === "dark" ? "#001B30" : "#ffffff",
